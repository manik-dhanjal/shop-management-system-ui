...
const TextBox = ({
	...
	return (
		<div className={`relative ${className}`}>
			<input
				className="text-m dark:bg-gray-800 border border-transparent dark:border-gray-700/60 rounded-lg overflow-hidden px-5 pt-6 w-full outline-none focus:border-slate-500 peer shadow-sm text-gray-700 dark:text-gray-300"
				id={otherProps.name}
				value={value}
				{...otherProps}
				type={type}
