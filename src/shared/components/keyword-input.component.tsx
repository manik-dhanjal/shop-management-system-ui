    ...
    <div className={`${className} max-w-full`}>
      ...
      <div className=" flex flex-wrap gap-3 max-w-full">
        {value.map((item, index) => (
          ...
          >
            <div className="max-w-[300px] truncate py-3 pr-3">{item}</div>
            <RxCross2
        ...
        <div className="relative inline-block w-40 shadow-sm">
          <input
            ...
            onKeyDown={handleAdd}
            className={`text-md border dark:bg-gray-800 bg-white text-gray-700 dark:text-gray-500 border-transparent dark:border-gray-700/60 rounded-lg overflow-hidden px-5 py-3 outline-non inline ${
              currentValue
