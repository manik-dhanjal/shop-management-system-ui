...
export interface AddOrderFormTypes {
  customer: {
    name: string;
    phone: string;
    email?: string;
...
interface AddOrderFormProps {
  onSubmit: SubmitHandler<AddOrderFormTypes>;
  isLoading: boolean;
  initialUserData?: AddOrderFormTypes;
}

export const INITIAL_FORM_VALUES: AddOrderFormTypes = {
  customer: {
    name: "",
    phone: "",
    email: "",
...
export const AddOrderPage = ({
  ...
  const { control, handleSubmit, watch, setValue } = useForm<AddOrderFormTypes>(
    {
      resolver,
  ...
  const onFormSubmit = (data: AddOrderFormTypes) => {
